...
import org.gui.canvas.EditInfo;
	...
	public Output(int xx, int yy) { super(xx, yy); }
	public Output(int xa, int ya, int xb, int yb, int f,
			 StringTokenizer st) {
	    super(xa, ya, xb, yb, f);
	}
	...
	public void draw(Graphics g) {
	    ...
	    String s = (flags & FLAG_VALUE) != 0 ? getVoltageText(volts[0]) : "saída";
	    ...
	    drawCenteredText(g, s, x_2, y_2-10, true);
