...
void Source::set_stamp(double** Yn, vector<double> nodal_solution,int num_vars)
{
    if(type=="V")
    {
        if(get_node_1()!=REFERENCIA)
        {
            Yn[get_node_1()-1][get_var()-1] = 1;
            Yn[get_var()-1][get_node_1()-1] = Yn[get_node_1()-1][get_var()-1];
        }
        if(get_node_2()!=REFERENCIA)
        {
            Yn[get_node_1()-1][get_var()-1] = -1;
            Yn[get_var()-1][get_node_2()-1] = Yn[get_node_2()-1][get_var()-1];
        }
        ...
        Yn[get_var()-1][num_vars] = get_value();
    ...
    else
    {
        if(get_node_1()!=REFERENCIA)
        {
            Yn[get_node_1()-1][get_var()] = Yn[get_node_1()-1][get_var()] - get_value();
        }
        
        if(get_node_2()!=REFERENCIA)
        {
            Yn[get_node_2()-1][get_var()] = Yn[get_node_2()-1][get_var()] + get_value();
        }
    }
}